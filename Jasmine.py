...
def reg():
    ...
    jalan('  PAY ONLY 350 FOR 1 MONTH  :) thank you')
    jalan('  FIRST SEND SCREENSHORT WITH TOKEN ON WHATSAPP ')
    jalan('  EASYPAISA ACCOUNT NO (KA LYA WHATSAPP PAR RABTA KARIN) ')
    jalan('  EASYPAISA ACCOUNT NAME (JEEVRAJ) ')
...
def reg2():
    ...
    os.system('xdg-open https://wa.me/+923480204796')
